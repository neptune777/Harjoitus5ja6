...
public class DatabaseContentAdapter extends RecyclerView.Adapter<DatabaseContentAdapter.CalculationViewHolder> {
    ...
    public DatabaseContentAdapter(Context context, Cursor cursor) {
    ...
    public void onBindViewHolder(CalculationViewHolder holder, int position) {
        ...
        String nimi = mCursor.getString(mCursor.getColumnIndex(DatabaseContract.DatabaseEntry.COLUMN_NIMI));
        String numero = mCursor.getString(mCursor.getColumnIndex(DatabaseContract.DatabaseEntry.COLUMN_NRO));
        String painos = mCursor.getString(mCursor.getColumnIndex(DatabaseContract.DatabaseEntry.COLUMN_PAINOS));
        String hankintapvm = mCursor.getString(mCursor.getColumnIndex(DatabaseContract.DatabaseEntry.COLUMN_HANKINTAPVM));
